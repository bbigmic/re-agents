      ...
      <div className="relative py-16 bg-white overflow-hidden">
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="text-lg max-w-prose mx-auto">
            ...
            <div ref={contactInfoRef} className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-3 scroll-mt-16">
              <div className="flex flex-col items-center p-8 bg-white rounded-lg shadow-lg">
                <PhoneIcon className="h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-2">Szybki Kontakt</h3>
                <p className="text-gray-600">+48 123 456 789</p>
                <p className="text-gray-600">Dostępny: 9:00-17:00</p>
              </div>

              <div className="flex flex-col items-center p-8 bg-white rounded-lg shadow-lg">
                <EnvelopeIcon className="h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-2">Zapytaj o Szczegóły</h3>
                <p className="text-gray-600">kontakt@reagents.pl</p>
                <p className="text-gray-600">Odpowiadam w 24h</p>
              </div>

              <div className="flex flex-col items-center p-8 bg-white rounded-lg shadow-lg">
                <MapPinIcon className="h-12 w-12 text-blue-500 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-2">Umów Spotkanie</h3>
                <p className="text-gray-600">ul. Przykładowa 123</p>
                <p className="text-gray-600">00-001 Warszawa</p>
              </div>
            </div>

            <div ref={mapRef} className="mt-16 scroll-mt-16">
